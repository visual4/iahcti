...
$GLOBALS['log']->debug("Starface debug: \$_REQUEST['phoneNr'] = {$_REQUEST['phoneNr']}");
$GLOBALS['log']->debug("Starface debug: \$_SESSION['authenticated_user_id'] = {$_SESSION['authenticated_user_id']}");

//$_REQUEST['phoneNr'] = "+49 179 6098437";
//$_SESSION['authenticated_user_id'] = 1;

StarfaceHelper::checkRequestParams(array('phoneNr'));
...
$callid = $server->placeCall($_REQUEST['phoneNr']);
